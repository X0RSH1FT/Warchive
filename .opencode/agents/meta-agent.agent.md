...
- When using `questions`, summarize the requested prompt-workflow pass first, explain the current intended route or file set, and then ask for the approval or decision that would change the next edit.
