---
name: review-code
description: Analyze provided code, identify bugs, suggest improvements, ensure adherence to architectural standards, and propose concrete fixes or refactoring steps.
